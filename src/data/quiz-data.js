...
const QUESTION_DATA = [
  ...
  },
  {
    question: (
      <span>
        What does the <code>bind</code> method do?
      </span>
    ),
    answers: [
      <span>
        Returns a function that, when executed, will call the original function
        with a <code>this</code> context that you pass in.
      </span>,
      <span>
        Prevents the value of <code>this</code> from being overridden by{" "}
  ...
  },
  {
    ...
    answers: [
      <span>
        With <code>Object.create</code> or <code>Object.setPrototypeOf</code>.
      </span>,
      <span>
        With <code>class Sub extends Super</code> in ES2015.
      </span>,
      <span>
        Using <code>Parent.prototype.method.call</code> inside{" "}
        <code>Child.prototype.method</code>.
      </span>,
      <span>All of the above.</span>
    ],
    correct: 3
  ...
  },
  {
    ...
    answers: [
      ...
      <span>
        Allows restricted resources (e.g. fonts) on a web page to be requested
        from an outside domain.
      </span>,
      <span>
        Allows scripts to interact more openly with content outside of the
        original domain, leading to better integration between web services.
      </span>,
      <span>All of the above.</span>
    ],
    correct: 3
  },
  {
    ...
    answers: [
      ...
      <span>
        A code snippet that is evaluated in the context of the current model
        scope, rather than within the scope of the global context (window).
      </span>,
      <span>
        A binding in double curly brackets that gets evaluated and the results
        appear in the DOM in place of it.
      </span>,
      <span>All of the above.</span>
    ],
    correct: 3
  ...
  },
  {
    ...
    answers: [
      ...
      <span>
        Prevents the use of global variables and the use of dangerous code like{" "}
        <code>with</code> and <code>eval</code>.
      </span>,
      <span>All of the above.</span>
    ],
    correct: 3
  },
  {
    ...
    answers: [
      ...
      <span>
        When the browser engine searches sideways on sibling elements for event
        handlers.
      </span>,
  ...
  },
  {
    ...
    answers: [
      ...
      <span>
        Attaching event handlers to a parent element rather than multiple child
        elements.
      </span>,
      <span>None of the above.</span>
    ],
  ...
  },
  {
    ...
    answers: [
      ...
      <span>
        A coding pattern in which a class receives the instances of objects it
        needs from an external source rather than creating them itself.
      </span>,
  ...
  },
  {
    question: (
      <span>
        Which of the following is FALSE about the <code>this</code> keyword?
      </span>
    ),
    answers: [
      <span>Its value is established at the invocation of a function.</span>,
      <span>
        When a function is invoked with the <code>new</code> keyword,{" "}
        <code>this</code> is bound to the new object.
      </span>,
  ...
  },
  {
    question: (
      <span>
        In Angular 2, which of the following are considered Structural
        Directives (directives that change DOM layout)?
      </span>
    ),
    answers: [
      <span>
        <code>NgFor</code> and <code>NgIf</code>
      </span>,
      <span>
        <code>NgStyle</code> and <code>NgClass</code>
      </span>,
      <span>
        <code>NgModel</code> and <code>NgForm</code>
      </span>,
      <span>None of the above.</span>
    ],
    correct: 0
  },
  {
    question: (
      <span>
        Which is TRUE about the events <code>load</code> and{" "}
        <code>DOMContentLoaded</code>?
      </span>
    ),
    answers: [
      <span>
        The <code>DOMContentLoaded</code> event comes after the{" "}
        <code>load</code> event.
      </span>,
      <span>
        <code>DOMContentLoaded</code> is fired when the document has been loaded
        and parsed; <code>load</code> fires when all files have finished
        loading, including images.
      </span>,
      <span>
        The <code>load</code> event is fired when only the DOM is loaded and
        parsed. <code>DOMContentLoaded</code> is fired when the document is
  ...
  },
  {
    question: (
      <span>
        Which of the following is NOT an example of a data structure in
        JavaScript?
      </span>
    ),
    answers: [
  ...
  {
    question: (
      <span>Which of the following is an aspect of a pure function?</span>
    ),
    answers: [
  ...
  },
  {
    ...
    answers: [
      ...
      <span>
        Sets the prototype of the new object to the constructor's prototype and
        calls the constructor.
      </span>,
      <span>
        Sets the <code>this</code> variable to the new object and returns the
        new object.
      </span>,
      <span>All of the above.</span>
    ],
  ...
  },
  {
    question: (
      <span>
        How is <code>let</code> different from <code>var</code>?
      </span>
    ),
    answers: [
      <span>
  ...
  },
  {
    question: (
      <span>
        Which of the following is TRUE about the <code>this</code> keyword?
      </span>
    ),
    answers: [
      <span>
        If a method is called, <code>this</code> refers to the object that the
        method is a property of. If the <code>new</code> keyword is used,{" "}
        <code>this</code> is the new object instance.
      </span>,
      <span>
        If <code>call</code>, <code>apply</code> or <code>bind</code> are used,{" "}
        <code>this</code> is the object that's passed in as the argument.
      </span>,
      <span>
        If none of the above conditions are met, <code>this</code> refers to the
        global object (<code>window</code> in the browser in non-strict mode;{" "}
        <code>global</code> in Node).
      </span>,
      <span>All of the above.</span>
    ],
    correct: 3
  },
  {
    question: (
      <span>
        Which of the following is something to look out for when using arrow
        functions?
      </span>
    ),
    answers: [
      <span>
        An arrow function receives the <code>this</code> value of its
        surrounding lexical scope at the time it was created; it behaves as if
        it had been created using <code>fn.bind(this)</code>.
      </span>,
      <span>
        If used in an event handler attached to a DOM element, the{" "}
        <code>this</code> variable will refer to the parent (usually the window)
        object rather than the element you're targeting.
      </span>,
  ...
  {
    question: (
      <span>What's an example of a practical use case for recursion?</span>
    ),
    answers: [
  ...
  },
  {
    question: (
      <span>
        What's the difference between <code>=</code>, <code>==</code>, and{" "}
        <code>===</code>?
      </span>
    ),
    answers: [
      <span>
        <code>=</code> is the basic assignment operator. It assigns the value of
        its right operand to its left operand.
      </span>,
      <span>
        <code>==</code> compares two values for equality AFTER converting both
        values to a common type.
      </span>,
      <span>
        <code>===</code> is used for strict equality. It checks for equality of
        both value AND type.
      </span>,
      <span>All of the above.</span>
    ],
  ...
  },
  {
    question: (
      <span>
        Which of the following is true about passing by value vs reference?
      </span>
    ),
    answers: [
      ...
      <span>
        Primitive types are passed by value and non-primitive types are passed
        by reference.
      </span>,
      <span>All of the above.</span>
    ],
  ...
  },
  {
    question: (
      <span>
        What is a <code>static</code> method?
      </span>
    ),
    answers: [
  ...
  },
  {
    ...
    answers: [
      <span>
        A variable is <code>undefined</code> when it's been declared but hasn't
        been assigned a value.
      </span>,
      <span>
        <code>null</code> is purposely assigned as a representation of "no
        value."
      </span>,
      <span>
        <code>undefined</code> is returned when trying to access a non-existant
  ...
  },
  {
    question: (
      <span>
        In React, which of the following is TRUE about the difference between an
    ...
    answers: [
      ...
      <span>
        A component is a <code>class</code> or a <code>function</code>.
      </span>,
  ...
  },
  {
    question: (
      <span>
        In React, which is TRUE about the difference between controlled
    ...
    answers: [
      ...
      <span>
        A controlled input accepts its current value as a prop, and a callback
        to change that value.
      </span>,
      <span>
        With uncontrolled components, form data is handled by the DOM, and input
        values can be accessed using refs.
      </span>,
      <span>All of the above.</span>
    ],
    correct: 3
  },
  {
    question: (
      <span>
        In React, what's the execution order for methods and lifecycle hooks on
        initial render?
      </span>
    ),
    answers: [
      <span>
        <code>componentDidMount()</code> → <code>render()</code> →{" "}
        <code>getDerivedStateFromProps()</code> → <code>constructor()</code>
      </span>,
      <span>
        <code>render()</code> → <code>componentDidMount()</code> →{" "}
        <code>constructor()</code> → <code>getDerivedStateFromProps()</code>
      </span>,
      <span>
        <code>constructor()</code> → <code>getDerivedStateFromProps()</code> →{" "}
        <code>render()</code> → <code>componentDidMount()</code>
  ...
  },
  {
    question: (
      <span>
        In React, which is TRUE about the difference between a class component,
    ...
    answers: [
      ...
      <span>
        A PureComponent is just like a class component, but handles
        shouldComponentUpdate for you, with a shallow check for changes in props
        or state. This allows for a performance boost by preventing unnecessary
        rerenders.
      </span>,
      <span>
        Functional components are presentational; they don't have access to
        state or lifecycle hooks, and can't use refs.
      </span>,
      <span>All of the above.</span>
    ],
    correct: 3
